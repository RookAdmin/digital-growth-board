        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16 animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
              <Button variant="homepage" size="lg" className="rounded-full px-8 py-6 text-lg font-medium shadow-lg w-full sm:w-auto" asChild>
              ...
              <Button variant="homepage" size="lg" className="border-2 border-green-300 text-green-700 bg-white rounded-full px-8 py-6 text-lg font-medium shadow-sm w-full sm:w-auto" asChild>
