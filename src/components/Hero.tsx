              ...
              <div className="relative w-full h-96 lg:h-[500px]">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="relative w-80 h-80 lg:w-96 lg:h-96">
                    {/* Main Circle */}
                    <div className="absolute inset-0 border-4 border-green-200 rounded-full animate-spin" style={{ animationDuration: '20s' }}></div>
                    
                    {/* Floating Elements */}
                    <div className="absolute top-8 left-8 w-16 h-16 bg-green-100 rounded-xl shadow-lg animate-bounce" style={{ animationDelay: '0s', animationDuration: '3s' }}>
                      <div className="flex items-center justify-center h-full text-2xl">📊</div>
                    </div>
                    
                    <div className="absolute top-16 right-8 w-20 h-20 bg-blue-100 rounded-full shadow-lg animate-bounce" style={{ animationDelay: '1s', animationDuration: '2.5s' }}>
                      <div className="flex items-center justify-center h-full text-2xl">💼</div>
                    </div>
                    
                    <div className="absolute bottom-16 left-12 w-14 h-14 bg-purple-100 rounded-lg shadow-lg animate-bounce" style={{ animationDelay: '2s', animationDuration: '3.5s' }}>
                      <div className="flex items-center justify-center h-full text-2xl">🚀</div>
                    </div>
                    
                    <div className="absolute bottom-8 right-16 w-18 h-18 bg-yellow-100 rounded-2xl shadow-lg animate-bounce" style={{ animationDelay: '0.5s', animationDuration: '2.8s' }}>
                      <div className="flex items-center justify-center h-full text-2xl">⚡</div>
                    </div>
                    
                    {/* Center Dashboard Mockup */}
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="w-48 h-32 bg-white rounded-xl shadow-2xl border border-gray-200 p-4 animate-pulse">
