    ...
    <section className="py-20 md:py-28 bg-white">
      <div className="container mx-auto px-4 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <Button variant="outline" className="border-gray-300 text-gray-800 hover:bg-gray-50 font-light rounded-full px-10 py-4 text-base shadow-sm hover:shadow-lg transform hover:-translate-y-1 transition-all duration-300" asChild>
            <Link to="/register">
              Contact
            </Link>
          </Button>
