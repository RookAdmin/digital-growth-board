...
-- Correct the create_client_user_from_client function
-- This function was inserting into auth.users with an incorrect column name 'email_change'
-- which caused authentication to fail. This corrects it to 'email_change_token_current'.
