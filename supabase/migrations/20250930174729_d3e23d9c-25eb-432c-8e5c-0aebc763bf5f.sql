-- Fix the create_client_user_from_client function to handle NULL values properly
...
BEGIN
  ...
  -- link it to the new client record in public.client_users, but only if they aren't already a client user.
